        ...
        <div className="border border-input border-t-0 border-x-0 rounded-t-lg p-2 bg-card flex flex-wrap gap-1 items-center">
            <TooltipProvider>
                ...
                <div className="flex flex-wrap gap-1">
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button disabled={!editor.can().undo()} size="sm" variant="ghost" type="button" onClick={() => editor.chain().focus().undo().run()}>
                                <Undo />
                            </Button>
                        </TooltipTrigger>
                        <TooltipContent>
                     ...
                     <Tooltip>
                        <TooltipTrigger asChild>
                            <Button disabled={!editor.can().redo()} size="sm" variant="ghost" type="button" onClick={() => editor.chain().focus().redo().run()}>
                                <Redo />
                            </Button>
                        </TooltipTrigger>
                        <TooltipContent>
