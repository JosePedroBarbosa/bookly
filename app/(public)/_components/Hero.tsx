...
const Hero = () => {
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-b from-white via-blue-50/30 to-white py-24 md:py-32">
      {/* Subtle Grid Pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#3B82F608_1px,transparent_1px),linear-gradient(to_bottom,#3B82F608_1px,transparent_1px)] bg-[size:32px_32px] opacity-40"></div>
        ...
        <div className="container mx-auto px-6 lg:px-8 text-center">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
              Manage appointments, automate reminders, and grow your business — all in one easy-to-use platform designed for modern entrepreneurs.
            </p>
      ...
      <div className="absolute top-20 right-10 w-80 h-80 bg-gradient-to-br from-blue-100/60 to-blue-200/40 rounded-full blur-3xl opacity-60" />
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-gradient-to-tr from-blue-50/70 to-blue-100/50 rounded-full blur-3xl opacity-70" />
      
      {/* Modern floating elements */}
      <div className="absolute top-1/3 left-1/4 w-4 h-4 bg-blue-400/30 rounded-full animate-ping"></div>
      <div className="absolute top-1/2 right-1/3 w-3 h-3 bg-blue-500/40 rounded-full animate-pulse delay-500"></div>
      <div className="absolute bottom-1/3 left-1/2 w-2 h-2 bg-blue-600/50 rounded-full animate-bounce delay-1000"></div>

      {/* Subtle geometric shapes */}
      <div className="absolute top-1/4 right-1/2 w-32 h-32 border border-blue-200/20 rounded-full animate-spin-slow"></div>
      <div className="absolute bottom-1/4 left-1/4 w-24 h-24 border border-blue-300/30 rounded-lg rotate-45 animate-pulse"></div>
    </section>
  );
};
